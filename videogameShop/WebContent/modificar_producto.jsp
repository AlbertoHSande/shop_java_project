			...
			<form action="servlet_producto?operacion=alta" method="post">
				...
				<div class="form-group">
					<label for="precio">Precio:</label> <input type="number"
						class="form-control" id="precio" name="precio"  pattern="[0-9]+([\.,][0-9]+)?" step="0.01" required="required">
				</div>
				...
				<div class="form-group">
					...
					<textarea class="form-control" rows="5" id="descripcion" name="descripcion" required="required"></textarea>
				</div>
